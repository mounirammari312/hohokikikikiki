...
export const presetDomains: StoreDomain[] = [
  {
    ...
    heroSubtitleAr: 'تشكيلة LUMIÈRE 2026 مطلية بذهب 18ق، لؤلؤ طبيعي وزركون AAA. تصميم باريسي، تسليم جزائري سريع والدفع عند الاستلام.',
  ...
  },
  {
    ...
    heroSubtitleAr: 'كولكشن أزياء 2026: فساتين سهرة، عباءات مخملية، حجابات حريرية وحقائب تُكمل إطلالتك — توصيل 58 ولاية والدفع عند الاستلام.',
    heroImage: 'https://images.unsplash.com/photo-1485230895905-ec40ba36b9bc?w=1400&q=80',
    footerDescriptionAr: 'دار أزياء جزائرية بلمسة باريسية. خامات فاخرة، قصّات عصرية، ومقاسات تناسب كل سيدة. الدفع عند الاستلام في 58 ولاية.',
    categories: [
  ...
  },
  {
    ...
    footerDescriptionAr: 'متجر الجمال الجزائري بلمسة باريسية. منتجات أصلية 100%، تركيبات آمنة، وتغليف هدية فاخر. الدفع عند الاستلام 58 ولاية.',
    categories: [
...
export const defaultSettings: StoreSettings = {
  ...
  email: "contact@lumiere.dz",
  announcement: "توصيل سريع لـ 58 ولاية • الدفع عند الاستلام • جودة مضمونة",
  freeShippingThreshold: 15000,
  heroTitleAr: "منتجات تُبرز أناقتك",
  heroSubtitleAr: "تشكيلة 2026 بجودة عالية وأسعار منافسة. تصميم عصري، تسليم جزائري سريع والدفع عند الاستلام.",
  heroBadge: "COLLECTION 2026 • ÉDITION LIMITÉE",
  footerDescriptionAr: "متجر جزائري بلمسة عصرية. منتجات بجودة عالية، مقاومة ومتينة. الدفع عند الاستلام في 58 ولاية.",
  instagram: "@lumiere.dz",
