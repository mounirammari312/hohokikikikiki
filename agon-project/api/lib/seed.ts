...
export const presetDomains: StoreDomain[] = [
  {
    ...
    heroTitleAr: 'مجوهرات تُضيء حضورك',
    ...
    footerDescriptionAr: 'بيت المجوهرات الجزائري بلمسة باريسية. مجوهرات مطلية بذهب 18ق، مقاومة للماء ولا تسبب حساسية. الدفع عند الاستلام في 58 ولاية.',
    categories: [
...
export const defaultSettings: StoreSettings = {
  ...
  announcement: "توصيل مجاني للطلبات فوق 15,000 د.ج • الدفع عند الاستلام في 58 ولاية",
